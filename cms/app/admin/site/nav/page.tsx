export default function NavSettingsPage() {
  return (
    <div className="px-8 py-8 max-w-2xl">
      ...
      <p className="text-[14px] mb-6" style={{ color: 'var(--muted)' }}>Manage site navigation links. Use the Site Annotator to request changes from the dev team.</p>
      <div className="p-6 rounded-[10px] border" style={{ borderColor: 'rgba(1,180,175,0.3)', background: 'rgba(1,180,175,0.05)' }}>
        ...
        <p className="text-[13px] leading-[1.6]" style={{ color: 'var(--muted)' }}>
          ...
          To request a nav change, use the Site Annotator or the dev request widget (bottom-right corner).
        </p>
      </div>
    </div>
  )
